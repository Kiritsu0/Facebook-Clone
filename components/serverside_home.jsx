...
import { MdGroups, MdOutlineWysiwyg, MdPayments, MdFlag, MdImage } from "react-icons/md";
...
const Serverhome = ({ linkNum }) => {
  ...
  const handleNav = () => {
    const icons = [
            ...
            <MdGroups 
              className="text-2xl text-white bg-blue-600 rounded-full px-1"/>,
            <PiVideoFill 
            ...
            <SiFacebookgaming 
              className="text-2xl text-blue-600 rounded-sm"/>,
            <RiMessengerFill 
              className="text-2xl text-blue-600"/>,
            <RiMessengerFill 
    ...
    let linkText = [
      ...
      "Groups", "Video", 
      "Marketplace", "Events", 
      "AdsManager", "Climate Science Center", 
      "Fundraisers", "Gaming Video", 
      "Messenger", "Messenger Kids", 
      "Orders and payments", "Pages", 
      "Play games", "Recent and activity"
    ];
    let nav = [];
