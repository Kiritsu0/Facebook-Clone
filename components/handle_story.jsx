              ...
              return storyData.type === "image" ? (
                ...
                >
                  <div className="bg-gray-400 h-full flex rounded-lg">
                    ...
                    <RxCross2 className="text-2xl cursor-pointer text-gray-400 absolute left-1 md:left-2 top-2" onClick={() => handleDeleteStory(index)} />
                  </div>
                </div>
              ) : (
                <div
                  key={index}
                  className="h-40 md:h-44 lg:h-52 w-28 md:w-32 lg:w-36 rounded-lg cursor-pointer shadow-lg hover:brightness-90 relative overflow-hidden"
                >
